...
public class UserDAOImpl implements UserDAO {
	...
	public User getUserByEmail(String email) {
		...
		try {
			...
			if (rs.next()) {
				user = new User(rs.getLong("id"), rs.getString("nom"), rs.getString("prenom"), rs.getString("role"),
						rs.getString("tel"), rs.getString("email"), rs.getString("password"), rs.getString("salt"),
		...
		try {
			...
			if (rs.next()) {
				user = new User(
						rs.getLong("id"),
						rs.getString("nom"), 
						rs.getString("prenom"), rs.getString("role"),
						rs.getString("tel"), rs.getString("email"), rs.getString("password"), rs.getString("salt"),
						rs.getString("avatar"), rs.getString("created_at"), rs.getString("updated_at"),
						rs.getString("deleted_at"));
			}
